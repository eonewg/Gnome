...
- **Gnome** 是 [mudkipme/MoeMemosAndroid](https://github.com/mudkipme/MoeMemosAndroid) 的个人定制分支，GPLv3，对 memos 和 MoeMemos 保持致谢（见 README）。
...
- 服务端兼容目标：Memos 0.21.0 与 0.27.0 – 0.30.0（以定制需求文档中的最新稳定版要求为准）。
