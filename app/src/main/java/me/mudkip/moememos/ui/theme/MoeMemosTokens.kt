...
internal val LightMoeMemosColors = MoeMemosColors(
...
internal val DarkMoeMemosColors = MoeMemosColors(
...
internal val LocalMoeMemosColors = staticCompositionLocalOf { LightMoeMemosColors }

object MoeMemosDesign {
    val colors: MoeMemosColors
        @Composable
        @ReadOnlyComposable
        get() = LocalMoeMemosColors.current
}
