...
class GnomeGlanceWidget : GlanceAppWidget() {
    ...
    private fun WidgetContent(context: Context, memoService: MemoService, prefs: Preferences) {
        ...
        val filterTag = prefs[GnomeWidgetKeys.filterTag]
        val pinnedOnly = prefs[GnomeWidgetKeys.pinnedOnly] ?: false
        val maxItems = prefs[GnomeWidgetKeys.maxItems] ?: 10
        val refreshKey = prefs[GnomeWidgetKeys.refreshKey] ?: 0L
...
class RefreshAction : ActionCallback {
    override suspend fun onAction(
        ...
        updateAppWidgetState(context, glanceId) { prefs ->
            val current = prefs[GnomeWidgetKeys.refreshKey] ?: 0L
            prefs[GnomeWidgetKeys.refreshKey] = current + 1
        }
        GnomeGlanceWidget().update(context, glanceId)
    }
}

object GnomeWidgetKeys {
